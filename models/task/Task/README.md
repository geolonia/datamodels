...
- Type IRI: `https://models.geonicdb.com/ns/task/Task`
...
- Schema: `https://models.geonicdb.com/schema/task/Task/v1.json`
- Page: https://models.geonicdb.com/models/task/Task/
