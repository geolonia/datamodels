...
One report from a resident or staff member: location, category, response status, who entered it, and the reporter (personal data). A subclass of Task in the task subject: name, progress and the other shared attributes use the task IRIs.
...
- Schema: `https://models.geonicdb.com/schema/disaster/IncidentReport/v2.json`
