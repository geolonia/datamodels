...
- Schema: `https://datamodels.jp/schema/disaster/RoadClosure/v1.json` (alias), `https://datamodels.jp/schema/disaster/RoadClosure/v1.0.0.json` (exact)
- Page: https://datamodels.jp/models/disaster/RoadClosure/
