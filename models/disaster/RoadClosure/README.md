...
One road closure: road name, closed section as a LineString, and status.

通行止め1件。路線名、区間（LineString）、状態を持つ。

- Type IRI: `https://models.geonicdb.com/ns/disaster/RoadClosure`
...
- Schema: `https://models.geonicdb.com/schema/disaster/RoadClosure/v1.json`
- Page: https://models.geonicdb.com/models/disaster/RoadClosure/
