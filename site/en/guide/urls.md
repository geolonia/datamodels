...
4. **Type and attribute IRIs resolve to documentation.** Opening `https://models.geonicdb.com/ns/disaster/RoadClosure` in a browser takes you to the type's page.
